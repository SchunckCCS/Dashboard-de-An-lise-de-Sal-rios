...
senioridade_selecionadas = st.sidebar.multiselect("Senioridades", senioridade_disponiveis, default=senioridade_disponiveis)
...
with col_graf2:
    if not df_filtrado.empty:
        ...
        st.plotly_chart(grafico_hist, use_continer_width=True)
    else:
